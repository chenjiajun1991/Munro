...
import com.sam.yh.common.baidugps.SendGpsToBaiduServerImpl;
...
//        把经纬度及时间信息发送给百度鹰眼API,移动端绘制轨迹用
//        if(sendGpsToBaiduServer==null){
//        	sendGpsToBaiduServer=new SendGpsToBaiduServerImpl();
//        }
